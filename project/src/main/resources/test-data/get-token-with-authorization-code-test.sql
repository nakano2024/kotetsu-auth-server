...
INSERT INTO clients(key, client_id, name, client_secret_hash)
    VALUES(
...
INSERT INTO authorization_codes(key, value, challenge, expired_at, access_type_name, grant_type_name, access_token_core_key, id_token_core_key, refresh_token_core_key)
    VALUES
    (
